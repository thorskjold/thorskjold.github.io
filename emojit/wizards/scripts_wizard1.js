    ...
    async function predict() {
        ...
        if (window.identify_eyes) {
            ...
            if (prediction[0].probability > 0.95) {
                ...
                document.getElementById("eyes").src = "wizard1_eyes.png";
            }
    ...
    async function predict() {
        ...
        if (window.identify_skin) {
            ...
            if (prediction[0].probability > 0.95) {
                ...
                document.getElementById("skin").src = "wizard1_skin.png";
            }
    ...
    async function predict() {
        ...
        if (window.identify_hair) {
            ...
            if (prediction[0].probability > 0.95) {
                ...
                document.getElementById("hair").src = "wizard1_hair.png";
            }
    ...
    async function predict() {
        ...
        if (window.identify_beard) {
            ...
            if (prediction[0].probability > 0.95) {
                ...
                document.getElementById("beard").src = "wizard1_beard.png";
            }
